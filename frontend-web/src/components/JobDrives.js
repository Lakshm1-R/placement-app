              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex flex-row flex-wrap items-center gap-2 ml-4">
                      <button
                      ...
                      {user?.role === "student" && !driveEnded && (
                        <>
                          {hasApplied(drive) ? (
                            ...
                            <span className="px-4 py-2 bg-red-100 text-red-800 rounded-lg text-sm font-medium text-center">
                              Deadline Passed
                            </span>
                          ) : isEligible ? (
                            <button
                            ...
                            <button
                              onClick={() => showEligibilityReasons(drive)}
                              className="px-4 py-2 bg-gray-100 text-gray-600 hover:bg-gray-200 rounded-lg text-sm font-medium text-center transition-colors"
                            >
                              Not Eligible
                            </button>
                          )}
